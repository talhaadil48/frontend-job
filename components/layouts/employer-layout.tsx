...
import { LayoutDashboard, FileText, PlusCircle, User, LogOut, Menu } from "lucide-react"
...
export default function EmployerLayout({ children }: EmployerLayoutProps) {
  ...
  const navItems = [
    {
      title: "Dashboard",
      href: `/employer/dashboard/${user?.id}`,
    ...
    <div className="flex min-h-screen flex-col">
      ...
      <div className="sticky top-0 z-30 flex h-16 items-center gap-4 border-b bg-background px-4 md:hidden">
        ...
        <div className="flex items-center gap-2">
          <Link href="/" className="flex items-center gap-2">
            <span className="text-lg font-bold">Employer Dashboard</span>
          </Link>
        </div>
      </div>
